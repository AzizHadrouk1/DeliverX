...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleNotFound(DeliveryNotFoundException ex, WebRequest request) {
    ...
    public ResponseEntity<ErrorResponse> handleAlreadyCompleted(DeliveryAlreadyCompletedException ex, WebRequest request) {
        return buildResponse(HttpStatus.CONFLICT, ex.getMessage(), request);
    }
